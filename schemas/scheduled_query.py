{
    ...
    "query_schedule": {"required": True, "type": "string", "nullable": False},
    "write_disposition": {"required": True, "type": "string", "nullable": False},
    "query": {"required": True, "type": "string", "nullable": False},
    "schema": {"required": True, "type": "string", "nullable": False},
    "iam_binding": {
        "required": True,
        "type": "dict",
        "schema": {
